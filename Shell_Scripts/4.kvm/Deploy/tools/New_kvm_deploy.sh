...
qemu-img create -f qcow2 -F qcow2 -b  $MACHINES_TEMPLATE_DISK  $HDD_PATH
...
sed -ri "s#/usr/libexec/qemu-kvm#/usr/bin/qemu-system-x86_64#" ${MACHINES_CONFIG_PATH}/${NEW_XML}
sed -ri "s#pc-i440fx-rhel7.0.0#pc-q35-6.2#" ${MACHINES_CONFIG_PATH}/${NEW_XML}
}
